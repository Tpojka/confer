...
- PHPUnit 11 and Orchestra Testbench 9 support.
...
- Explicitly cast `pluck()` results to arrays when used with native PHP functions (Laravel 11+ compatibility).

### [11.0.0] - 2026-02-22

#### Added
- Support for Laravel 11.0 (`illuminate/support: ^11.0`).
- Minimum PHP requirement bumped to `>=8.2` to match Laravel 11.
